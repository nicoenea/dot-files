...
#define COLOUR_1 vec4(0.5, 0.15, 0.12, 1.0)     // Brighter red, more visible
#define COLOUR_2 vec4(0.08, 0.25, 0.4, 1.0)     // Brighter blue, more visible  
#define COLOUR_3 vec4(0.12, 0.15, 0.2, 1.0)     // Lighter background for more detail
#define CONTRAST 2.5
...
vec4 effect(vec2 screenSize, vec2 screen_coords) {
    ...
    baseEffect.rgb *= 0.85; // Only reduce brightness by 15%
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    float textContrast = hasContent * 0.88 + (1.0 - hasContent) * 0.0;
